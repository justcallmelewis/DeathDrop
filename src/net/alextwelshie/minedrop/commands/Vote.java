	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		if(sender instanceof Player) {
			...
			if(args.length == 0 || args.length > 1) {
				...
				player.sendMessage(Main.getPlugin().prefix + "§3§l1. §b" + SettingsManager.getInstance().getData().getString(VoteHandler.getInstance().maps.get(0) + ".displayName") + "§8 - §a" + VoteHandler.getInstance().getVotes(0) + " §6votes.");
				player.sendMessage(Main.getPlugin().prefix + "§3§l2. §b" + SettingsManager.getInstance().getData().getString(VoteHandler.getInstance().maps.get(1) + ".displayName") + "§8 - §a" + VoteHandler.getInstance().getVotes(1) + " §6votes.");
				player.sendMessage(Main.getPlugin().prefix + "§3§l3. §b" + SettingsManager.getInstance().getData().getString(VoteHandler.getInstance().maps.get(2) + ".displayName") + "§8 - §a" + VoteHandler.getInstance().getVotes(2) + " §6votes.");
				player.sendMessage(Main.getPlugin().prefix + "§3§l4. §b" + SettingsManager.getInstance().getData().getString(VoteHandler.getInstance().maps.get(3) + ".displayName") + "§8 - §a" + VoteHandler.getInstance().getVotes(3) + " §6votes.");
